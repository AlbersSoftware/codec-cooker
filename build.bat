...
src/main.cpp src/dct.cpp src/multiFrame.cpp src/quantization.cpp src/chain.cpp src/entropy.cpp src/loopFilter.cpp ^
...
:: Copy icon next to exe so stbi_load("codec-cooker-icon.png") finds it
copy src\codec-cooker-icon.png codec-cooker-icon.png >nul 2>&1
